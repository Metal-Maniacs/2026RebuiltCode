...
public class ElevatorAutoL2 extends Command {
  ...
  /*
   * You should conside using the more terse Command factories API instead
  ...
  public void execute() {
    ...
    /*
     * while (Timer.getTimestamp() - initTime >= 2 && (Timer.getTimestamp() -
     * initTime <= 2.5)){
     * mElevator.elevate(.5d);
     * }
     * // After 2.5 seconds and before 4.5 seconds
     * while(Timer.getTimestamp() - initTime > 2.5 && (Timer.getTimestamp() -
     * initTime <= 4.5)){
     * mElevator.elevate(.5d);
     * }
     * /*
     ...
     * }
     * 
     * while(Timer.getTimestamp() - initTime > 5 && (Timer.getTimestamp() - initTime
     * <= 10)){
     * System.out.println(Timer.getTimestamp() - initTime);
     * m_DriveSubsystem.drive(0,0, .1, false, .13);
     * }
     * while(Timer.getTimestamp() - initTime > 10 && (Timer.getTimestamp() -
     * initTime <= 15)){
     * System.out.println(Timer.getTimestamp() - initTime);
